...
module.exports.loop = function () {
    ...
    for (let spawnName in Game.spawns) {
        ...
        var numberOfLongDistanceHarvestersW37S86 = _.sum(Game.creeps, (c) =>
            c.memory.role == 'longDistanceHarvester' && c.memory.target == 'W37S86');
       ...
       //     c.memory.role == 'longDistanceHarvester' && c.memory.target == 'W2N4');
        ...
        // if not enough repairers
            ...
            // if not enough longDistanceHarvesters for W37S86
        else if (numberOfLongDistanceHarvestersW37S86 < spawn.memory.minLDHW37S86) {
            // try to spawn one
            name = spawn.createLongDistanceHarvester(energy, 2, spawn.room.name, 'W37S86', 0);
        }
